    ...
    value: async function startWsServer() {
      ...
      io.on('connection', function (socket) {
        ...
        socket.on('status', function () {
          ...
          var status = {
            balance: _this.state.channelState ? _this.state.channelState.balanceTokenUser : "0",
            txHistory: [],
            hubCollateral: _this.state.channelState ? _this.state.channelState.balanceTokenHub : "0",
            status: _this.state.autopayState
          };
